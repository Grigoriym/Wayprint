...
/**
 * The `04 Riesa - Meissen.gpx` fixture used by [GpxParserTest], [RdpTest], and [RouteArtTest],
 * inlined as a string constant rather than loaded via classpath resource lookup
 * (`javaClass.getResourceAsStream`), which has no Kotlin/Native equivalent (see docs/revisit.md).
 */
private const val RIESA_MEISSEN_GPX = """
